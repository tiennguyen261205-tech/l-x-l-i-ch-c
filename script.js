...
const wishesDB = {
   "Bố": "Con kính chúc Bố năm mới Bính Ngọ sức khỏe dẻo dai, tâm thế bình an và luôn giữ được ngọn lửa vui vẻ trong cuộc sống. Mong mọi dự định của Bố đều thành công rực rỡ, vạn sự cát tường, như ý! ❤️",
    ...
    "Tongtaicuaem": "Chúc tổng tài của em năm mới Bính Ngọ vạn sự như ý!Chúc tổng tài luôn giữ được sự kiên định, bản lĩnh trong học tập cũng như cuộc sống. Mong năm nay tài lộc đến với tổng tài cụa emmmm dồi dào, dự định lớn nhỏ đều sớm đạt được thành quả như ý nheee! 🧧💎",
    ...
    "Bemoxinhiuu": "Chúc Trang năm mới xinh đẹp hơn người, tiền vào như nước, tình duyên phơi phới. Mong 2026 sẽ là một năm đầy những trải nghiệm tuyệt vờiiiii! 💃✨",
