...
const wishesDB = {
   "Bố": "Con kính chúc Bố năm mới Bính Ngọ sức khỏe dẻo dai, tâm thế bình an và luôn giữ được ngọn lửa vui vẻ trong cuộc sống. Mong mọi dự định của Bố đều thành công rực rỡ, vạn sự cát tường, như ý! ❤️",
    ...
    "Bà nội": "Con kính chúc Bà năm mới thêm tuổi mới nhưng sức khỏe luôn dẻo dai, tâm hồn luôn an nhiên, vui vẻ. Mong Bà sống lâu trăm tuổi để chứng kiến con cháu trưởng thành và tận hưởng những giây phút bình yên, sum vầy nhất bên gia đình nhéeee! 🧧",
